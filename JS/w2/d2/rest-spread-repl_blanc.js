...
const restSum = (...otherNums) => {
  // write a method that sums up all arguments
  return otherNums.reduce((acc, el)=> {
    acc += el
    return acc;
  }, 0)

};
console.log(restSum(1,2,2))
// * 2. spreadItOut
const spreadItOut = (array1, array2) => {
  // write a method that spreads two arrays into one, combining all elements
  return [...array1, ...array2];
};
console.log(spreadItOut([888,999,0],[17,89,56]))
// * 3. breakDownObj
const breakDownObj = (obj) => {
   //write a method that breaks down an object into collection of keys and values and puts everything into an array and returns it
   return [...Object.keys(obj), ...Object.values(obj)]
};

console.log(breakDownObj({name: "Pavel", age: "16", address:  "Fremont", zip: "12345"}))
